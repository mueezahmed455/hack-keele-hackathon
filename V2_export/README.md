# Geo-Sense Africa v2.2 — Dual-Board Multi-Hazard Early Warning System
...
**Latest Version:** 2.2.0 - Production Ready with Security Hardening
...
│  │  • Dot Matrix 8x8    │                    │ • Buzzers     │ │
│  │  • HC-SR04 (Flood)   │                    │ • Photoresistor││
│  │  • DHT11 (Air)       │                    │ • Potentiometer││
│  │  • PIR Motion        │                    │               │ │
│  │  • Soil Moisture     │                    │               │ │
│  │  • SG90 Servo        │                    │               │ │
│  │  • Relay (Siren)     │                    │               │ │
...
2. **Serial Fusion** (Every 2s)
   - Arduino transmits: `W:xx.x,T:xx.x,S:xx.x,P:x.xx,I:x`
...
| Dot Matrix DIN | GPIO23 | SPI (MOSI) | MAX7219 |
| Dot Matrix CLK | GPIO26 | SPI (SCK) | **Note: Moved to avoid conflict** |
...
### Arduino Slave Pinout

| Component | Pin | Type | Notes |
|-----------|-----|------|-------|
| **Sensors** | | | |
| Water Level | A1 | ADC | |
| Thermistor | A2 | ADC | 10k series |
| Photoresistor | A3 | ADC | 10k series |
| Potentiometer | A4 | ADC | Calibration |
| Tilt Switch | D2 | Interrupt | FALLING edge |
| **Outputs** | | | |
| Active Buzzer | D3 | Output | |
| Passive Buzzer | D11 | PWM | |
| 7-Segment A-F | D4,D5,D6,D12,D13,A5 | Output | 220Ω each |
| **Serial** | | | |
| TX to ESP32 | D1 | UART | **Voltage divider required** |
| RX from ESP32 | D0 | UART | |
...
### Flash Arduino Slave
1. Open `GeoSense_Arduino_Slave.ino` in Arduino IDE
...
2. **Observe**: 
   - Buzzer screams (2.5kHz continuous)
   - Red LED flashes
   - Servo slams to 180°
